                                        ...
                                        foreach($allassign as $assign) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="<?php echo $helper->url("assign","chstatus"); ?><?php echo $send_status; ?>&id_assign=<?php echo $assign->getId(); ?>&param=id_<?php echo htmlentities($_SESSION['id_user']); ?>_type_<?php echo htmlentities($_SESSION['type']); ?>" title="<?php echo $title; ?>" >
                                                        <span class="<?php echo $icon_class; ?>"></span>
                                                    </a>
                                                    <a href="<?php echo $helper->url("assign","modify"); ?>&id_assign=<?php echo $assign->getId(); ?>" title="Modify">
                                                        <span class="glyphicon glyphicon-pencil"></span>
                                                    </a>
                                                    <?php if ($_SESSION['type'] == 2) { ?>
                                                        <a href="<?php echo $helper->url("assign","delete"); ?>&id_assign=<?php echo $assign->getId(); ?>" title="Delete">
