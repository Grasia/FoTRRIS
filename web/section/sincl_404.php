        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <h4><a href="guideline.php" target="_blank"><?php echo _("User Guidelines"); ?></a></h4>
                    <h4><a href="description.php" target="_blank"><?php echo _("About the FoTRRIS co-RRI web platform"); ?></a></h4>
                    <h4><?php if (!login_check($mysqli) == true) { ?>
                            <a href="login.php" class="btn btn-info btn-lm">
                                <span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<?php echo _("Please Login"); ?>
                            </a>
                        <?php } ?>
                    </h4>
